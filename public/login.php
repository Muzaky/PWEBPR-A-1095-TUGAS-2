        ...
        <div class="container flex flex-col justify-center items-center w-[500px] h-[600px] border-orange-950 border shadow bg-[#d2c1b0] rounded-[16px]">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm flex flex-col">
                <form class="flex flex-col " action="index.php">
                    ...
                    <div class="mt-1 ">
                        <input type="password" class="block w-full rounded-[12px] border-0 px-[12px] py-[8px] font-[poppins] text-gray-900 shadow-sm placeholder:text-gray-200 focus:ring-2 focus:ring-inset focus:ring-[#80411e] sm:text-sm sm:leading-6" placeholder="Masukkan Password" required="">
                    </div>
            ...
            <div>
                ...
                <p class="mt-4 text-center text-sm text-[#ad6d2f] font-[poppins]">
                    Not a member ?
                    <a href="register.php" class="font-semibold leading-6 text-[#37251b] hover:text-[#80411e] font-[poppins]">Register here</a>
                </p>
            </div>
        </div>
    </div>
