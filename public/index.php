                                        ...
                                        <tbody>
                                            <tr class="font-[poppins]">
                                                ...
                                                <td class="px-6 py-4 flex gap-x-3 justify-center">
                                                    ...
                                                    <button onclick="showDelButton(<?= $id ?>)" id="delButton_<?= $id ?>" class="font-medium text-lg bg-transparent rounded-md border-t-2 border-l-2 border-b-4 border-r-4 border-red-600">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-6 h-6">
