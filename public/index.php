...
<body class="flex flex-col ">
                ...
                <div class="flex-1 px-4 flex justify-between">
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="absolute right-20">
                            <a href="login.php" class="text-[#37251b] text-bold text-[16px] border py-1 px-4 border-[#37251b] rounded-[6px] font-[poppins] hover:text-[#f4f4f4] hover:bg-[#ad6d2f]">Sign Out</a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            <tr class="font-[poppins]">
                                                ...
                                                <td class="px-6 py-4 flex gap-x-3 justify-center">
                                                    ...
                                                    <button onclick="showDelButton(event, <?= $id ?>)" class="font-medium text-lg bg-transparent rounded-md border-t-2 border-l-2 border-b-4 border-r-4 border-red-600">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-6 h-6">
                                                ...
                                                <div id="delbutton" class="fixed left-0 top-0 bg-black bg-opacity-40 w-screen h-screen flex items-center justify-center opacity-0 hidden 
                 transition-opacity duration-500">
                                                    <div class="bg-white rounded shadow-md p-8 w-[25%] gap-5 flex-col overflow-hidden">
                                                        ...
                                                        <div class=" mt-3 flex justify-end">
                                                            <button onclick="hideDelButton()" class="bg-white rounded px-4 py-2 mr-3 text-black cursor-pointer hover:bg-gray-300">Batal</button>
                                                            <form class="flex" id="deleteForm">
                                                                <a href="index.php?action=delete&id=<?= $id ?>" class="bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded">Hapus</a>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="4" class="px-6 py-4 text-[16px] font-medium text-[#37251b] text-center">Tidak Ada Data</td>
                                        </tr>
                                    </tbody>
                                <?php
                                }
    ...
    <script>
        ...
        function showDelButton(event, id) {
            let delbutton = document.getElementById('delbutton')
            document.getElementById('deleteForm').href = "index.php?action=delete&id=" + id;;
